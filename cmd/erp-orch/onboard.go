...
func init() {
	onboardCmd := &cobra.Command{
		Use:   "onboard",
		Short: "Set up erp-orch for a new project",
		Long: `Interactive setup wizard for configuring erp-orch with a new project.
...
func runOnboard(cmd *cobra.Command, args []string) error {
	fmt.Println()
	fmt.Println("  ╔═══════════════════════════════════════╗")
	fmt.Println("  ║   ERP Orchestrator Project Onboarding  ║")
	fmt.Println("  ╚═══════════════════════════════════════╝")
	fmt.Println()
	...
	dataDir := filepath.Join(home, ".erp-orchestrator")
	...
	configDir := filepath.Join(home, ".config", "erp-orchestrator")
	...
	configContent := fmt.Sprintf(`# ERP Orchestrator Configuration
...
`
	...
	fmt.Println("     erp-orch sync")
	fmt.Println()
	fmt.Println("  3. Start the orchestrator:")
	fmt.Println("     erp-orch start              # Start ready tasks")
	fmt.Println("     erp-orch tui                # TUI dashboard")
	fmt.Printf("     erp-orch serve              # Web UI at http://%s:%d\n", webHost, webPort)
	fmt.Println()
	fmt.Println("  4. Monitor progress:")
	fmt.Println("     erp-orch status             # Quick summary")
	fmt.Println("     erp-orch list               # All tasks")
	fmt.Println()
